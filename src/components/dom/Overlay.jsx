      ...
      <div className='w-full inline-flex items-center'>
        <div className='tracking text-xs basis-1/3'>
          <button
            ...
            className={
              props.isPerfActive
                ? 'font-bold border-2 hover:text-zinc-900 text-white bg-zinc-900 border-zinc-900 px-10 py-4 transition-all duration-300 ease-in-out buttonSideFill relative overflow-hidden'
                : 'font-bold border-2 hover:text-white border-zinc-900 px-10 py-4 transition-all duration-300 ease-in-out buttonSideFill relative overflow-hidden'
            }>
            <span
              className={
                props.isPerfActive
